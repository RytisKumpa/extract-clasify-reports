"""
Pydantic models for due diligence report schema.

This module defines the schema for due diligence reports covering commercial,
financial, legal, technical, operational, regulatory, and other DD disciplines.
...
# Technology & IT section (unique to Due Diligence)
class SecurityMeasureItem(BaseModel):
    """Individual cybersecurity measure."""
    measure_type: Optional[str] = Field(default=None, description="Type of security measure")
    description: Optional[str] = Field(default=None, description="Description of the security measure")
...
class VulnerabilityItem(BaseModel):
    ...
    vulnerability_type: Optional[str] = Field(default=None, description="Type of vulnerability")
    severity: Optional[str] = Field(default=None, description="Severity assessment")
    description: Optional[str] = Field(default=None, description="Description of the vulnerability")
    mitigation_status: Optional[str] = Field(default=None, description="Current mitigation status")


class TechnologyAndIT(BaseModel):
    """Technology and IT analysis including stack and cybersecurity."""
    tech_stack_summary: Optional[str] = Field(
        default=None,
        description="Summary of technology stack and key technologies used"
    )
    core_platforms: Optional[List[str]] = Field(
        default=None,
        description="Core technology platforms and systems"
    )
    cloud_vs_onprem: Optional[str] = Field(
        default=None,
        description="Cloud vs on-premises deployment strategy"
    )
    cloud_providers: Optional[List[str]] = Field(
        default=None,
        description="Cloud service providers used"
    )
    document_stated_technical_debt_description: Optional[str] = Field(
        default=None,
        description="Description of technical debt and legacy system issues"
    )
    planned_it_investment: Optional[str] = Field(
        default=None,
        description="Planned IT investments and upgrades"
    )
    document_stated_cybersecurity_description: Optional[str] = Field(
        default=None,
        description="Summary of cybersecurity posture and practices"
    )
    cybersecurity_incidents_disclosed: Optional[List[str]] = Field(
        default=None,
        description="History of cybersecurity incidents or breaches"
    )
    document_stated_data_governance_description: Optional[str] = Field(
        default=None,
        description="Data governance and management practices"
    )
    key_third_party_dependencies: Optional[List[str]] = Field(
        default=None,
        description="Key third-party software or service dependencies"
    )
    document_stated_system_integration_description: Optional[str] = Field(
        default=None,
        description="System integration architecture and approach"
    )
    security_measures: Optional[List[SecurityMeasureItem]] = Field(
        default=None,
        description="Array of cybersecurity measures"
    )
    vulnerabilities: Optional[List[VulnerabilityItem]] = Field(
        default=None,
        description="Array of cybersecurity vulnerabilities"
    )
    notes: Optional[str] = Field(default=None, description="Additional technology and IT notes")


# ESG section (unique to Due Diligence)
class ESGFactorItem(BaseModel):
    """Individual ESG factor or initiative."""
    category: Optional[str] = Field(default=None, description="ESG factor category")
    description: Optional[str] = Field(default=None, description="Description of the factor or initiative")
    impact: Optional[str] = Field(default=None, description="Assessment of impact or significance")


class ESG(BaseModel):
    """Environmental, Social, and Governance analysis."""
    controversial_sector_exposure: Optional[str] = Field(
        default=None,
        description="Exposure to controversial sectors or industries"
    )
    geographic_controversial_exposure: Optional[str] = Field(
        default=None,
        description="Geographic exposure to controversial regions"
    )
    governance: Optional[List[str]] = Field(
        default=None,
        description="Governance structure and practices"
    )
    environmental: Optional[List[str]] = Field(
        default=None,
        description="Environmental factors and sustainability practices"
    )
    social: Optional[List[str]] = Field(
        default=None,
        description="Social factors and impact analysis"
    )
    regulatory_exposure: Optional[List[str]] = Field(
        default=None,
...
# Main Due Diligence Schema
class DueDiligenceSchema(BaseModel):
    """
    Comprehensive due diligence report schema for investment analysis.

    Covers commercial, financial, legal, technical, operational, regulatory,
    and other DD disciplines. Comprehensive analysis for investment decision-making.

    Follows anti-hallucination extraction policy:
    - Extract only what the document STATES
    - Use simple types for factual data
    - Use structured types for complex data
    ...
    technology_and_it: Optional[TechnologyAndIT] = Field(default=None, description="Technology and IT analysis")
    esg: Optional[ESG] = Field(default=None, description="Environmental, Social, and Governance analysis")
